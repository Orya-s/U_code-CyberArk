...
def verify_authorization_header(auth_header: str) -> Tuple[List[str], FastAPIUser]:
    ...
    scopes = ["admin", "standard"]  # You could for instance use the scopes provided in the JWT or request them by looking up the scopes with the 'sub' somewhere
    return scopes, user
...
if __name__ == '__main__':
    uvicorn.run('exercises:app', host="127.0.0.1", port=8000)  # Starts the uvicorn ASGI