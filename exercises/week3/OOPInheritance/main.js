...
console.log(`${s0.name} received an ${firstGrade.grade} in ${firstGrade.course}`)
...
const s = new Student("Ronda", 2017)
const t = new Teacher("Cassandra", 2002, 40000)
const p = new Person("Anon", 1999)
...
// s1 instanceof p1     // error  - p1 is not a class
...
class Principal extends Person {
    ...
    hireTeacher(teacher) {
        ...
        // <principal name> just hired <teacher name>
